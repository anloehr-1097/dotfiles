...
** ivy-occur & occur
The goal here is to mimic the workflow of vims 'vimgrep' & 'cdo' operations. Use *occur* or
*multi-occur*
** wgrep
#+begin_src emacs-lisp
    (use-package wgrep
...
** trimming whitespace in latex eq
